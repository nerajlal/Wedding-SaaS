...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Cinzel:wght@400;600;700&family=Montserrat:wght@300;400;500&display=swap"
        rel="stylesheet">
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Alex+Brush&family=Cormorant+Garamond:ital,wght@0,400;0,600;1,400;1,600&display=swap"
        rel="stylesheet">
    <style>
    ...
    <div class="theme-wrapper">
        ...
        <div class="person-section">
            <div class="person-img-wrap">
                <img class="pv-groom-img-src"
                    src="{{ !empty($invitation->groom_image_url) ? $invitation->groom_image_url : (!empty($details['groom_image_url']) ? $details['groom_image_url'] : 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&q=80&w=400') }}">
                <div class="person-hearts">
                    <span class="red">❤</span><span class="white">❤</span>
                </div>
            </div>
            <h2 class="person-name" data-preview="groom_name">
                {{ $invitation->groom_name ?? $details['groom_name'] ?? 'Rixon' }}</h2>
        ...
        <div class="person-section">
            <div class="person-img-wrap">
                <img class="pv-bride-img-src"
                    src="{{ !empty($invitation->bride_image_url) ? $invitation->bride_image_url : (!empty($details['bride_image_url']) ? $details['bride_image_url'] : 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=400') }}">
                <div class="person-hearts">
                    <span class="red">❤</span><span class="white">❤</span>
                </div>
            </div>
            <h2 class="person-name" data-preview="bride_name">
                {{ $invitation->bride_name ?? $details['bride_name'] ?? 'Rivona' }}</h2>
        ...
        <div class="event-card">
            ...
            <div class="event-card-body">
                ...
                <div class="event-detail">
                    ...
                    <div class="event-detail-text">
                        <strong
                            data-preview="venue_name">{{ $invitation->venue_name ?? $details['venue_name'] ?? 'Guardian Angel Catholic Church' }}</strong><br>
                        <span data-preview="venue_address"
                            style="display: block; margin-top: 4px;">{{ $invitation->venue_address ?? $details['venue_address'] ?? 'Moralien, Kakoda, Vodlemol Cacora, South Goa' }}</span>
                    </div>
                </div>
                ...
                <div style="margin-top: 1.5rem; width: 100%; max-width: 440px; margin-left: auto; margin-right: auto;">
                    <div
                        style="display:flex; flex-direction:column; align-items:center; justify-content:center; gap:0.8rem; padding: 1.2rem 1rem; border-radius: 12px; border: 1px solid rgba(161, 63, 93, 0.15); background: rgba(161, 63, 93, 0.04); text-align: center;">
                        <div>
                            <p
                                style="font-family:'Cinzel',serif; font-weight:700; font-size:0.8rem; letter-spacing:1px; text-transform:uppercase; color:#a13f5d; margin:0 0 0.3rem;">
                                Venue directions</p>
                            <p
                                style="font-family:'Montserrat',sans-serif; font-size:0.75rem; color:#736063; line-height:1.4; margin:0;">
                                Open the location in Maps to find the venue with ease.</p>
                        </div>
                        <a class="pv-location-url"
                            href="{{ $hasValidLocationUrl ? $locationUrl : 'javascript:void(0)' }}" target="_blank"
                            rel="noopener noreferrer"
                            style="display: {{ $hasValidLocationUrl ? 'inline-flex' : 'none' }}; align-items:center; justify-content:center; gap:0.45rem; padding:0.7rem 1.1rem; border-radius:8px; background: #a13f5d; color: #fff; text-decoration:none; font-family:'Montserrat', sans-serif; font-size:0.8rem; font-weight:600; letter-spacing:0.5px; box-shadow: 0 4px 12px rgba(161,63,93,0.15); margin-top: 0.5rem; transition: transform 0.2s ease;">
                            View on map
                        </a>
                    </div>
                </div>
        ...
        <div class="gallery-section"
            style="{{ (isset($invitation) && $invitation->galleries && $invitation->galleries->count() > 0) ? '' : 'display:none;' }}">
